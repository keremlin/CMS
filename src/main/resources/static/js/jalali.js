...
function date2convertReverse(date) {
    var date1=new Date(date);
    console.log(date1);
    console.log(date1.getFullYear()+"-"+(date1.getMonth()+1)+"-"+date1.getDate());
    var jalali=gregorian_to_jalali_reverse(date1.getFullYear(),(date1.getMonth()+1),date1.getDate());
    return jalali;
};
...
function gregorian_to_jalali_reverse(g_y, g_m, g_d) {
